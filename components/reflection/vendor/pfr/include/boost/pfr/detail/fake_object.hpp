...
template <class T> extern const wrapper<T> do_not_use_PFR_with_local_types;
...
// This takes advantage of C++20 features, while
// boost::pfr::detail::unsafe_declval works with the former standards.
