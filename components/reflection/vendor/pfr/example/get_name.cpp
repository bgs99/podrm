...
/*`
    Since C++20 it's possible to read name of a structure field by index using
   Boost.PFR library. The following example shows how to do it using [funcref
   boost::pfr::get_name].
...
*/
constexpr std::string_view n1 =
    boost::pfr::get_name<0, foo>(); // returns "some_integer"
