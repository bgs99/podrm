...
template <class... Types> auto make_stdarray(const Types &...t) {
...
void test_get_name_1() {
  BOOST_TEST_EQ(((boost::pfr::get_name<0, Aggregate1>())),
                "EXuT_0EBItazIzOuovbOSyOYGqbJw1uQ");
}
void test_get_name_2() {
  BOOST_TEST_EQ(((boost::pfr::get_name<0, Aggregate2>())),
                "SnihXdx4VbVTcwKm2PGOy8gBYi");
  BOOST_TEST_EQ(((boost::pfr::get_name<1, Aggregate2>())),
                "l_hKC0UCDgf9akyA6pr1IG");
}
void test_get_name_3() {
  BOOST_TEST_EQ(
      ((boost::pfr::get_name<0, Aggregate3>())),
      "GWYXwjwOCC5uOWkmZjrjk95yaOQbVfUbSJRCoQoRyPXjzp7x2c7WMwvck0JeOg");
  BOOST_TEST_EQ(((boost::pfr::get_name<1, Aggregate3>())),
                "xdtwasd3bFi2mErdk64LyyWKcOb5gudT50eCBMUHraYYmd8Yxp9M0pO1DmDHWQ"
                "Z4LEshxseqUjzoTeuwnVwA6uvStNpN0ZtZ");
  BOOST_TEST_EQ(((boost::pfr::get_name<2, Aggregate3>())),
                "shqTJk7vA32s2DQB5o7TyecNLMHLUogzWYO_NwRsgX");
}
void test_get_name_4() {
  BOOST_TEST_EQ(((boost::pfr::get_name<0, Aggregate4>())),
                "ofYcwHz8V6YMDPsHqyIB5TVZckFc3cK0Da");
  BOOST_TEST_EQ(((boost::pfr::get_name<1, Aggregate4>())), "HiGE0sOlKCO");
  BOOST_TEST_EQ(((boost::pfr::get_name<2, Aggregate4>())),
                "F5Nrv0LUdUSmrzLgPmtENIEe5uJQyRXC0owDVh9IjRBdA_aSEqiMx_"
                "EhWXEkbddK5MCgCv223s9EXlMc55ByxpG6XYbXS6nHywEy");
  BOOST_TEST_EQ(((boost::pfr::get_name<3, Aggregate4>())), "emjjbXYK");
}
void test_get_name_5() {
  BOOST_TEST_EQ(((boost::pfr::get_name<0, Aggregate5>())),
                "M0u7SIZSVWJ0KqQygT_"
                "6npmZv1XzZI5dJcwjQuqq6lIdlSJSpnAKhOg82qyVywwNq3cvvmnmAv7");
  BOOST_TEST_EQ(((boost::pfr::get_name<1, Aggregate5>())), "SXEUFB6z");
  BOOST_TEST_EQ(((boost::pfr::get_name<2, Aggregate5>())), "tDxT");
  BOOST_TEST_EQ(((boost::pfr::get_name<3, Aggregate5>())),
                "sV2m6xg3MxKN1Xln2dXyBh8rkF7lUUfHIK8nK4FRzru2DXeT");
  BOOST_TEST_EQ(((boost::pfr::get_name<4, Aggregate5>())),
                "ycEXe3x03PvbXqFJzOKMq8i4XLAZfyY2i4HONhv1Wx_");
}

void test_names_as_array_1() {
  const auto expected =
      make_stdarray(std::string_view{"EXuT_0EBItazIzOuovbOSyOYGqbJw1uQ"}
...
void test_names_as_array_2() {
  const auto expected =
      make_stdarray(std::string_view{"SnihXdx4VbVTcwKm2PGOy8gBYi"},
...
void test_names_as_array_3() {
  const auto expected = make_stdarray(
      std::string_view{
          "GWYXwjwOCC5uOWkmZjrjk95yaOQbVfUbSJRCoQoRyPXjzp7x2c7WMwvck0JeOg"},
      std::string_view{"xdtwasd3bFi2mErdk64LyyWKcOb5gudT50eCBMUHraYYmd8Yxp9M0pO"
                       "1DmDHWQZ4LEshxseqUjzoTeuwnVwA6uvStNpN0ZtZ"},
...
void test_names_as_array_4() {
  const auto expected = make_stdarray(
      ...
      std::string_view{"F5Nrv0LUdUSmrzLgPmtENIEe5uJQyRXC0owDVh9IjRBdA_aSEqiMx_"
                       "EhWXEkbddK5MCgCv223s9EXlMc55ByxpG6XYbXS6nHywEy"},
...
void test_names_as_array_5() {
  const auto expected = make_stdarray(
      std::string_view{
          "M0u7SIZSVWJ0KqQygT_"
          "6npmZv1XzZI5dJcwjQuqq6lIdlSJSpnAKhOg82qyVywwNq3cvvmnmAv7"},
      std::string_view{"SXEUFB6z"}, std::string_view{"tDxT"},
