...
// * outputs full name of the function so that PFRs extraction of field name
// could be adjust to new compiler without requesting regression tester's help
...
inline constexpr auto no_check_stored_name_of_field =
    detail::name_of_field_impl<
        T, detail::make_clang_wrapper(
               std::addressof(detail::sequence_tuple::get<I>(
